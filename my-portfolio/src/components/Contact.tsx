...
import { Copy, Mail, MapPin, Phone, Wrench, Rocket, Bug, Cloud } from 'lucide-react';
...
const services = [
	{
		icon: Rocket,
		title: 'React / Next.js features',
		description: 'Frontend components, routing, SSR, and performance tuning.',
	},
	{
		icon: Wrench,
		title: 'Node.js / Express APIs',
		description: 'RESTful endpoints, authentication, and database integration.',
	},
	{
		icon: Bug,
		title: 'Bug fixes & performance',
		description: 'Troubleshooting, optimization, and code reviews.',
	},
	{
		icon: Cloud,
		title: 'Deployments (Vercel)',
		description: 'CI/CD, hosting, and production deployment support.',
	},
];
